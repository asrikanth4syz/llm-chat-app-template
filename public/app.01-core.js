...
const NAV = {
  platform: [
    ...
    { id:'delivery_variances',  label:'Delivery Variances', icon:iconEye,    badge:'!' },
    ...
    { id:'price_revisions', label:'Price Revisions',  icon:iconReports,  badge:'!' },
    { id:'price_report',    label:'Price Changes',    icon:iconPie,      badge:null },
  ...
  client: [
    ...
    { id:'price_approvals',label:'Price Approvals',icon:iconReports,   badge:'!' },
    { section:'My Store' },
...
const PAGE_MAP = {
  ...
  delivery_variances: 'renderDeliveryVariances',
  ...
  smart_catalogue: 'renderSmartCatalogue',
  product_review: 'renderProductIntel',
  product_reports: 'renderProductReports',
