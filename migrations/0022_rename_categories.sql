...
UPDATE inventory       SET category = 'Stationery'  WHERE category = 'Stationery';
...
UPDATE client_inventory SET category = 'Stationery'  WHERE category = 'Stationery';
...
UPDATE order_items     SET category = 'Stationery'  WHERE category = 'Stationery';
